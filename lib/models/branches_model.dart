...
Branches branchesFromJson(String str) =>
    Branches.fromJson(json.decode(str) as Map<String, dynamic>);
...
class Branches {
  ...
  factory Branches.fromJson(Map<String, dynamic> json) => Branches(
        ...
        isStaffOnly: json['is_staff_only'].toString(),
        isFront: json['is_front'].toString(),
        location: json['location'].toString(),
        status: json['status'].toString(),
        phone: json['phone'].toString(),
        address: json['address'].toString(),
        city: json['city'].toString(),
        parishname: json['parishname'].toString(),
        openHour: json['open_hour'].toString(),
        code: json['code'].toString(),
        colorCode: json['color_code'].toString(),
        isInhouseDelivery: json['is_inhouse_delivery'].toString(),
        isThirdpartyDelivery: json['is_thirdparty_delivery'].toString(),
        music: json['music'].toString(),
        musicOrg: json['music_org'].toString(),
        branchCode: json['branch_code'].toString(),
        branchCodeImage: json['branch_code_image'].toString(),
        insertTimestamp: DateTime.parse(json['insert_timestamp'].toString()),
        updateTimestamp: DateTime.parse(json['update_timestamp'].toString()),
      );
